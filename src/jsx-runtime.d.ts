...
export function jsxs(tag: string | Component, props: JSX.Props): string;
export function jsxDev(tag: string | Component, props: JSX.Props): string;
export function Fragment(props: JSX.Props): string;
...
export namespace JSX {
	...
	interface HtmlTag extends ElementChildrenAttribute, IntrinsicAttributes {
		...
		onauxclick?: undefined | string;
		onbeforeinput?: undefined | string;
		onbeforematch?: undefined | string;
		onbeforetoggle?: undefined | string;
		onblur?: undefined | string;
		oncancel?: undefined | string;
		...
		oncontextlost?: undefined | string;
		oncontextmenu?: undefined | string;
		oncontextrestored?: undefined | string;
		oncopy?: undefined | string;
		oncuechange?: undefined | string;
